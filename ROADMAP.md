...
Priority:
Only after intelligence gains begin to flatten.
...
Data Collection & Signal Detection
...
- Hiring archetypes
- Company watchlists
- Persistence-aware conviction
- Persistence-aware narratives
- AI Commercialization detection
...
The project goal is not to collect more data for its own sake.

The project goal is to convert hiring data into valuable intelligence.